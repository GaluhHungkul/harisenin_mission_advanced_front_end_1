const SubscriptionOff = () => {
  return (
    <div className="bg-[#3D4142] absolute top-4 w-[90%] rounded-xl  right-1/2 translate-x-1/2 h-[191px] flex items-start px-4 py-6 gap-6 lg:static lg:translate-x-0 lg:flex-1">
        ...
        <button className="bg-primary/40 px-6 py-1 rounded-full hover:bg-primary/60 active:bg-primary/80 cursor-pointer mt-6 absolute -bottom-14 right-0">Mulai Berlangganan!</button>
      </section>
    </div>
  )
}
